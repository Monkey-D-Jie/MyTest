    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             *
                name=张三, psw=123456
                name=hello, psw=null
             * 1.读取后psw的内容为null---因为 psw 使用transient关键字修饰的
             * 2.name值为hello，说明静态变量至始至终都是 内存中的 name属性值。
             * 这里在反序列化之前把name设置为了’Hello‘
             * 不过，并不建议这样去改变 staitc的值。这里也有错误提示:不应该通过类实例来访问静态变量。（这样会增加无谓的解析成本--阿里巴巴）
             */
